...
final List<_PetitionDef> _kEstatePetitions = [
  ...
  _PetitionDef(
    ...
    const Petition(
      ...
      stakes:
          'İzin verirsen bir el eksilir; tutarsan {ad} kalır ama gönlü kalmaz.',
      bodyPool: [
      ...
      options: [
        PetitionOption(
          ...
          detail:
              '{ad} mesleğini bırakır; içi rahatlar, eski iş bir süre sahipsiz kalır.',
          resolutionPool: [
        ...
        PetitionOption(
          ...
          detail:
              'Düzen bozulmaz. {ad} işinin başına döner, gönlü orada değildir.',
          resolutionPool: [
  ...
  _PetitionDef(
    ...
    const Petition(
      ...
      stakes:
          'Gönüllerini almak keseden çıkar; belini kırmak köyün '
          'sabrından.',
      bodyPool: [
      ...
      options: [
        PetitionOption(
          ...
          detail:
              '{hane} Hanesi\'na hakkı teslim edilir. Ellerine dönerler, '
        ...
        PetitionOption(
          label: 'Belini kır',
          detail:
              '{hane} Hanesi\'nin sözü meclis önünde kesilir. Küskün '
        ...
        PetitionOption(
          ...
          detail:
              'Hiçbir şey yapılmaz. {hane} Hanesi esirgemeye devam eder; '
    ...
    const Petition(
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Diyet keseden çıkar. İki hane aynı sofraya oturur, husumet kapanır.',
          resolutionPool: [
        ...
        PetitionOption(
          ...
          detail:
              'En çok kan dökeni yola vurursun. Husumet uzaklaşır, bir ocak sönük kalır.',
          resolutionPool: [
        ...
        PetitionOption(
          ...
          detail:
              'Halkın önünde infaz. Kan davası kanla kapanır, köy günlerce susar.',
          resolutionPool: [
    ...
    const Petition(
      ...
      bodyPool: [
        ...
        '“Bu {mevsim} ne oğlumun yüzünü gördüm ne karımın. Karanlıkta çıkıyoruz, '
            'karanlıkta dönüyoruz; çocuk beni yabancı sanıyor. Emekçiler adına '
  ...
  _PetitionDef(
    ...
    const Petition(
      ...
      stakes:
          'Bir kese altın tezgâhı doğrultur; ilgisizlik ustayı köyden soğutur.',
      bodyPool: [
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Kese açılır: yeni tezgâh, sağlam çatı. Harmandakiler burulur.',
          resolutionPool: [
    ...
    const Petition(
      ...
      options: [
        ...
        PetitionOption(
          ...
          detail:
              'Sofra kurulmaz. Yaşlılar akşam yemeğini yine tek başına yer.',
          resolutionPool: [
  ...
  _PetitionDef(
    (c) =>
        (c.ascendant == Estate.laborers || c.remembers('identity.laborers')) &&
        c.food >= 20,
    0.7,
    const Petition(
  ...
  // 🔨 Zanaat Kasabası → Zanaat Panayırı (kervan alıcıları gelir, kazanç).
  _PetitionDef(
    (c) =>
        (c.ascendant == Estate.artisans || c.remembers('identity.artisans')) &&
        c.population >= 6,
    0.7,
    const Petition(
      ...
      stakes: 'Panayır kurulursa kervanın kesesi bizim tezgâhta boşalır.',
      bodyPool: [
        '“Efendim, dün kervandan bir alıcı geldi, sırf benim yaptığım orak için. Bir '
            'panayır kuralım, kervan her geçişinde burada dursun; biz her seferinde '
            'eşeğe yükleyip yollara düşmeyelim.”',
        ...
        '“Ambarda altmış parça iş bekliyor; alıcısı yok değil, gelemiyor. Bir panayır '
            'ilan et, kervan tezgâhları bir gün için buraya aksın. Zararımız bir günlük '
            'çekiç sesi, kârı kese dolusu.”',
      ],
      options: [
        PetitionOption(
          label: 'Panayırı kur!',
          detail: 'Meydan tezgâhla dolar. Kervanın kesesi burada boşalır.',
          resolutionPool: [
            '🔨 Panayır kuruldu. Akşama kadar örs sesi dinmedi, kese doldu.',
            '🔨 Kervan alıcıları akın etti. {ad-in} tezgâhında tek parça kalmadı.',
          ],
          goldDelta: 8,
          moraleAmount: 0.10,
          moraleDays: 3,
  ...
  _PetitionDef(
    (c) =>
        (c.ascendant == Estate.faithful || c.remembers('identity.faithful')) &&
        c.population >= 5,
    0.7,
    const Petition(
      ...
      bodyPool: [
        '“Efendim, kervanla gelip bizim ateşimizin başında dua eden var artık. '
  ...
  _PetitionDef(
    (c) =>
        (c.ascendant == Estate.hearth || c.remembers('identity.hearth')) &&
        c.food >= 18,
    0.7,
    const Petition(
      ...
      bodyPool: [
        ...
        '“Efendim, {hane} kapısında kırk kişi yemek yer, dar gelmez. Öteki hanelerin kapısı da '
