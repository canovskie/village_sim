    ...
    const Petition(
      ...
      bodyPool: [
        ...
        '“Bu köy bir işi kaybetti. Kimse konuşmuyor ama hepimiz biliyoruz. '
            'Bir sonraki kervanda o işi bilen bir usta var derler. Yol parası verirseniz '
            'kervanla gider, öğrenir, geri getiririm. Getiremezsem de gitmiş sayılmam ya.”',
      ],
      options: [
        PetitionOption(
          label: 'Yola çıkar (12★)',
    ...
    const Petition(
      ...
      options: [
        PetitionOption(
          label: 'Dinle',
          detail:
              'Meydanda konuşmasına izin verilir. Huzursuzluk iner, otorite yumuşar.',
          resolutionPool: [
