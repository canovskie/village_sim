...
final List<_PetitionDef> _kFactionPetitions = [
  ...
  // 💰 Pazar vergisi — Emekçiler kervandan vergi ister (ambar fonu).
  _PetitionDef(
    (c) => c.adults >= 5,
    0.7,
    const Petition(
      ...
      stakes:
          'Vergi ambarı doldurur, kervanı küstürür. Serbest pazar tersini yapar.',
      bodyPool: [
        '“Efendim, pazarda bir kile buğdayın parası benim elime bir avuç geliyor, '
            'kervanın kesesine bir kese. Toprağı ben kazıyorum. Küçük bir pazar vergisi '
        ...
        '“{ad} benim, harmanı ben savuruyorum. Geçen hafta kendi buğdayımı pazardan '
            ...
            'koy.”',
        '“Kimse kervana düşman değil; malı o taşıyor, riski o alıyor. Ama kâr tek kapıda '
      ...
      options: [
        PetitionOption(
          label: 'Vergiyi koy',
          detail: 'Kervandan pay alınır, ortak kese dolar. Tezgâh homurdanır.',
          resolutionPool: [
            '💰 Pazar vergisi kondu. Ortak kese doldu, kervancılar tartıyı iki kez kontrol etti.',
        ...
        PetitionOption(
          ...
          resolutionPool: [
            '💰 Pazar serbest kaldı. Kervancılar keseyi bağladı, çiftçiler başını çevirdi.',
  ...
  _PetitionDef(
    (c) => c.population >= 6 && (c.hasChurch || c.remembers('cult.active')),
    0.6,
    const Petition(
      id: 'holyDay',
    ...
    const Petition(
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Kararlar önce ihtiyarların kapısından geçer. Gençler geride bekler.',
          resolutionPool: [
  ...
  _PetitionDef(
    ...
    const Petition(
      ...
      tone: PetitionTone.neutral,
      stakes:
          'Yol kervan getirir, kervan yabancı âdet. Kapalı köy huzurlu ama dar.',
      bodyPool: [
        ...
        '“Bu köyün yolu bir katır patikası, araba bile geçmiyor. Kervan bize '
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Geçit açılır. Kervan, kazanç, uzak haber; bir de yabancı âdet.',
          resolutionPool: [
        ...
        PetitionOption(
          ...
          resolutionPool: [
            ...
            '🏡 Kapılar kapalı kaldı. Kervan mallarını yine katıra yükledi.',
          ],
    ...
    const Petition(
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Bir gecelik erzak gider. Meydanda pazar kurulur, kese dolar.',
          resolutionPool: [
  ...
  // 🧳 Göçmen kervanı — yorgun yolcular kapıda; kabul mü, geçiş mi?
  _PetitionDef(
    (c) => c.population >= 6,
    0.5,
    const Petition(
      id: 'migrantCaravan',
      petitioner: 'Yorgun bir kervan',
      icon: '🧳',
      title: 'Kapıda Bir Kervan',
      tone: PetitionTone.neutral,
      estate: Estate.artisans,
      ...
      options: [
        PetitionOption(
          ...
          detail:
              'Sofraya boğaz eklenir. Yeni eller, yeni yüzler, tedirgin bir ocak.',
          resolutionPool: [
            '🧳 Kervan içeri alındı. Ebe daha ilk gece bir doğuma yetişti.',
        ...
        PetitionOption(
          label: 'Geçip gitsinler',
          detail: 'Kapı kapalı. Kervan yoluna devam eder, köy düzenini korur.',
          resolutionPool: [
            '🚪 Kervan yola devam etti. Çeşmenin başında dört çocuk ayakkabısı unutulmuştu.',
  ...
  // 🏴 Gezgin kervan temsilcisi — ticaret anlaşması mı, kendi yolumuz mu?
  _PetitionDef(
    (c) => c.population >= 8 && c.gold >= 4,
    0.45,
    const Petition(
      id: 'neighborEnvoy',
      petitioner: 'Gezgin kervanın kâtibi',
      icon: '🏴',
      title: 'Kervandan Teklif',
      tone: PetitionTone.neutral,
      estate: Estate.artisans,
      stakes: 'Anlaşma keseyi doldurur; mühür yabancıyla kurulan ilk bağ olur.',
      bodyPool: [
        '“Selam getirdim, bir de teklif. Kervanımızın unu var, sizin demiriniz. Yılda iki '
            'kez burada pazar kuralım, tartıyı ortak tutalım. Şu berata bir mühür bas, '
            'gerisi yol üstünde yürür.”',
        '“Efendim, bu yoldan her geçişimizde başka tartı, başka vergi çıkıyor. Bir berat '
            'yazalım; kervan tezgâhını burada açsın, köy malını uzak pazara biz taşıyalım. '
            'Yol ikimize de kazandırsın.”',
      ...
      options: [
        PetitionOption(
          label: 'Kervan beratını mühürle',
          detail: 'Kervan köyde pazar kurar; kese dolar, inananlar burulur.',
          resolutionPool: [
            '🏴 Berat mühürlendi. İlk ortak pazar köy yolunda kuruldu; kervan ve köy tartıyı birlikte tuttu.',
            '🏴 Kervanın kâtibi keseyi masada bıraktı. {köy} ilk kez dışarıdan kazandı.',
          ],
          goldDelta: 8,
          // Eski kayıtlarla uyumlu dahili anahtar; oyuncuya tanımsız bir dış
          // yerleşim diye gösterilmez, artık kervan anlaşmasını temsil eder.
        ...
        PetitionOption(
          label: 'Kendi yolumuz',
          detail:
              'Berat mühürsüz kalır. Köy ruhunu korur, tezgâh fırsatı kaçırır.',
          resolutionPool: [
            '🕯️ Kervanın kâtibi geri çevrildi. Beratı katlayıp koynuna koydu, tek kelime etmedi.',
            '🕯️ Anlaşma olmadı. Kervan yoluna devam etti; tezgâh fırsatı da onunla gitti.',
          ],
          estateMood: [
