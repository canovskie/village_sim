enum ResourceBoxType { woodChunk, stoneBox, ironBox, coalBox, foodBasket }
...
class ResourceBox {
  ...
  /// Tek görünen paketin temsil ettiği miktar. Maden/kütük 1; böğürtlen
  /// sepeti bir toplama turunun tamamını taşır.
  final int amount;
