...
List<_SceneEntry> _scenes() => [
      ...
      _SceneEntry('Kademe 1', 'yabancının karşılanması · şafak',
          () => cutsceneForTier(1)!),
      _SceneEntry('Kademe 2', 'pazar + meydan · akşam',
          () => cutsceneForTier(2)!),
      _SceneEntry('Kademe 3 (final)', 'dolu köy + başlık kartı',
          () => cutsceneForTier(3)!),
      _SceneEntry('Kıtlık', 'boş ambar · akşam', () => kFamineCutscene),
