            ...
            body: Stack(
              ...
              children: [
                ...
                VillageLedger(
                  ...
                  seats: seats,
                  openHouseCard:
                      -1, // capture: kart kapalı (kamulaştırma kartı görünsün)
                  massSeizure: const HouseActionEntry(
                    icon: '⚑',
                    label: 'MÜLKİYETİ KALDIR',
                    detail:
                        'Bu köy mülkü kutsal sayıyor. Ortak sofraya '
                  ...
                  houseActionsFor: (surname) => const [
                    ...
                    HouseActionEntry(
                      ...
                      label: 'Mala el koy',
                      detail:
                          'Hane defteri fermanı mühürlü değil — neyin kimde '
                    ...
                    HouseActionEntry(
                      ...
                      label: 'Sürgüne yolla',
                      detail:
                          'Meclis buna razı olmaz. Bu yetki ancak sözün '
