...
/// Yakın LOD'da mikro çimen dekoru alan tile yüzdesi.
const int kMicroDetailChancePercent = 14;

/// Deterministik mikro dekor havuzundaki görsel tür sayısı.
const int kMicroDetailKindCount = 8;

/// Mikro dekor havuzunda çiçeğe ayrılan tür sayısı.
const int kMicroDetailFlowerKindCount = 1;
...
class TileRenderer {
  ...
  static final List<Paint> _fillVariants = [
    Paint()
      ..color = const Color(0xFF58B45E)
      ..isAntiAlias = false, // 0
    Paint()
      ..color = const Color(0xFF7AB050)
      ..isAntiAlias = false, // 1
    Paint()
      ..color = const Color(0xFF6CAA55)
      ..isAntiAlias = false, // 2
    Paint()
      ..color = const Color(0xFF509644)
      ..isAntiAlias = false, // 3
    Paint()
      ..color = const Color(0xFF3D7E36)
      ..isAntiAlias = false, // 4
    Paint()
      ..color = const Color(0xFF6A803E)
      ..isAntiAlias = false, // 5
    Paint()
      ..color = const Color(0xFF6FA470)
      ..isAntiAlias = false, // 6
    Paint()
      ..color = const Color(0xFF9A8B5C)
      ..isAntiAlias = false, // 7
  ];

  // Dekor paint havuzu — sabit renkler
  static final _pFlowerYellow = Paint()
    ..color = const Color(0xFFEED854)
    ..isAntiAlias = false;
  static final _pFlowerRed = Paint()
    ..color = const Color(0xFFE0432E)
    ..isAntiAlias = false;
  static final _pFlowerWhite = Paint()
    ..color = const Color(0xFFEEEEEE)
    ..isAntiAlias = false;
  static final _pFlowerPurple = Paint()
    ..color = const Color(0xFFB870D8)
    ..isAntiAlias = false;
  static final _pPebble = Paint()
    ..color = const Color(0xFFA0998A)
    ..isAntiAlias = false;
  static final _pPebbleDark = Paint()
    ..color = const Color(0xFF807868)
    ..isAntiAlias = false;
  static final _pTuftDark = Paint()
    ..color = const Color(0xFF386838)
    ..isAntiAlias = false;
  static final _pBlade = Paint()
    ..color = const Color(0xFF82C268)
    ..isAntiAlias = false;
  ...
  static final List<Paint> _pSand = [
    Paint()
      ..color = const Color(0x55E6D49A)
      ..isAntiAlias = false, // 1 yan
    Paint()
      ..color = const Color(0x88E6D49A)
      ..isAntiAlias = false, // 2 yan
    Paint()
      ..color = const Color(0xAAE6D49A)
      ..isAntiAlias = false, // 3+ yan
  ];
  ...
  static Future<ui.Image?> _load(String path) async {
    try {
      ...
      return await AssetStyle.softenAtLoad(
        frame.image,
  ...
  static void drawGrassTile(
    ...
    final variant = jitter < 10
        ? baseTone
        : ((baseTone + (jitter < 13 ? 1 : -1)) % _imgVariants.length +
                  _imgVariants.length) %
              _imgVariants.length;
    final hash = micro;
    ...
    if (zoom >= 0.8) {
      ...
      if (decorRoll < kMicroDetailChancePercent) {
  ...
  static void _drawDecor(
    ...
    final kind = ((hash >> 8) & 0x7) % kMicroDetailKindCount;
    ...
    if (kind < kMicroDetailFlowerKindCount) {
      // Çiçek + sap
