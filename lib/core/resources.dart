...
class ResourceBundle {
  ...
  /// Hazır savunma silahları. Demirci üretir, keşfedilen zulalardan da çıkabilir.
  int weapons;
  ...
  void add(ResourceKind k, int amount) {
    switch (k) {
      ...
      case ResourceKind.food:
        food += amount;
      case ResourceKind.honey:
        honey += amount;
      case ResourceKind.reed:
        reed += amount;
  ...
  void clear() {
    wood = stone = iron = coal = food = honey = reed = wool = gold = weapons =
        0;
  }
