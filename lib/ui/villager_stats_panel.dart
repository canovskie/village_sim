...
/// KÖY NÜFUS DEFTERİ — köylüleri kim/hangi hane/ne iş/ne kadar varlıklı/ne kadar
/// mutlu olduklarıyla topluca gösteren tam-ekran istatistik modalı. İki sekme:
///   • Köylüler — sıralanabilir/filtre'li tekil liste (portre + hane + meslek +
///     servet çubuğu + moral).
...
class VillagerStatsPanel extends StatefulWidget {
  ...
  @override
  State<VillagerStatsPanel> createState() => _VillagerStatsPanelState();
}

class _VillagerStatsPanelState extends State<VillagerStatsPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    final h = math.min(size.height * 0.88, 720.0);
    final w = math.min(size.width * 0.94, 600.0);
    return Positioned.fill(
      child: Stack(
        children: [
          // Scrim — boşluğa dokun = kapat.
          Positioned.fill(
          ...
          Center(
            child: GestureDetector(
              onTap: () {}, // panele tıklama scrim'e geçmesin
              child: AppReveal(
                child: SizedBox(
                  width: w,
                  height: h,
                  child: AppPanel(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(height: 1, color: AppUi.line),
                        Expanded(
                          child: _tab == 0 ? _villagerTab() : _houseTab(),
                        ),
                      ],
                    ),
                  ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const GameIcon(GameIconData.people, size: 18, color: AppUi.accent),
              const SizedBox(width: 9),
              Expanded(
                child: Text('KÖY NÜFUS DEFTERİ',
                    style: AppUi.title.copyWith(letterSpacing: 1.5)),
              ),
              AppIconButton(
                  icon: GameIconData.close, size: 26, onTap: widget.onClose),
            ],
          ),
